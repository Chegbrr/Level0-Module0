...
if __name__ == '__main__':
    ...
    name = simpledialog.askstring(title=" ", prompt="If you find yourself having to cross a piranha-infested river here's how to do it...")
    # Get the player to enter an adjective
    adjective = simpledialog.askstring(title=" ", prompt="Enter an adjective")
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title=" ", prompt="Enter a type of liquid")
    # Get the player to enter a body part
    bp = simpledialog.askstring(title=" ", prompt="Enter a body part")
    # Get the player to enter a verb
    verb = simpledialog.askstring(title=" ", prompt="Enter a verb")
    # Get the player to enter a place
    place = simpledialog.askstring(title=" ", prompt="Enter a place")
    ...
    storyFinal = simpledialog.askstring(title=" ", prompt=story)
